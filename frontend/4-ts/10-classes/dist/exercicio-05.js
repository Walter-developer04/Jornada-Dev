...
class Gerente extends Funcionario {
    bonusDeResultados;
    constructor(nome, salarioBase, bonusDeResultados) {
        super(nome, salarioBase);
        this.bonusDeResultados = bonusDeResultados;
    }
...
class Estagiario extends Funcionario {
    horasDeApoio;
    constructor(nome, salarioBase, horasDeApoio) {
        super(nome, salarioBase);
        this.horasDeApoio = horasDeApoio;
    }
