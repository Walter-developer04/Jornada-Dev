...
class ContaBancaria {
  ...
  protected taxaDeSaque: number;

  constructor(titular: string, saldoInicial: number, taxaDeSaque: number) {
...
class ContaPoupanca extends ContaBancaria {
  private rendimentoPercentual: number;
