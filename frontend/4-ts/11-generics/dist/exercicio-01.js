...
// ============================================================================
{
    function montarPar(primeiro, segundo) {
...
// ============================================================================
{
    ...
    function primeiroElemento(itens) {
        return itens[0];
    }
    console.log(primeiroElemento(["Ana", "Bruno"])); // Ana
    console.log(primeiroElemento([])); // undefined
}
// ============================================================================
...
// ============================================================================
{
    ...
    const caixaDeTexto = new Caixa("chave de fenda");
