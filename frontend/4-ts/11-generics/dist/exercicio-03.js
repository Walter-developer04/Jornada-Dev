...
// ============================================================================
{
    ...
    const caderno = { nome: "Caderno", preco: 15, disponivel: true };
    const nomeDoProduto = obterCampo(caderno, "nome");
    const precoDoProduto = obterCampo(caderno, "preco");
...
// ============================================================================
{
    function buscarPorId(itens, idDesejado) {
