...
// ============================================================================
{
    ...
    const dobrar = function (entrada) {
        return entrada * 2;
    };
    const gritar = function (entrada) {
    ...
    function aplicarDuasVezes(valor, operacao) {
...
// ============================================================================
{
    ...
    function criarHistorico() {
        const itens = [];
        return {
            empilhar: function (item) {
                itens.push(item);
            },
            desempilhar: function () {
                return itens.pop();
            },
            topo: function () {
