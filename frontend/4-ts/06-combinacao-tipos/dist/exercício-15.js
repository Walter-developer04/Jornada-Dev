...
const entrada1 = { texto: "Parametro Alfa" };
const entrada2 = { valor: 99 };
...
const entradaValidaPorReferencia = objetoIntermediario;
// 2. EXEMPLO INCORRETO
...
const entradaInvalida = { texto: "Parametro Gama", metadadoExtra: "info-99" };
// 3. MINI-DESAFIO
// Declare uma variavel 'configuracaoValida' do tipo ParametroEntrada usando o membro OpcaoNumerica.
const configuracaoValida = { valor: 250 };
// Solucao comentada:
