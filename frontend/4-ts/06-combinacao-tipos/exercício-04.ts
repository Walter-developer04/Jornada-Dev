...
// 1. EXEMPLO CORRETO
type DadoEntrada = string | number;

function formatarDado(entrada: DadoEntrada): string {
...
// 2. EXEMPLO INCORRETO
function multiplicarEntrada(entrada: DadoEntrada): number {
...
function processarMedida(medida: string | number): number {
